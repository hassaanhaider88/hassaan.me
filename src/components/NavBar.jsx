...
const NavBar = ({ Projectpage }) => {
  ...
  return (
    <>
        ...
        <span className="flex justify-center items-center sm2:hidden bg-white rounded-full text-black dark:text-white MobileHumburgurIcon">
          <label className="hamburger">
            ...
            <svg viewBox="0 0 32 32">
              <path
                className="line-top-bottom line"
      ...
      <div
        className={`fixed ${
          IsMenuOpen === true ? "left-0" : "-left-[100%]"
        } z-30 duration-500 dark:bg-black bg-white top-20 px-4 rounded-2xl w-full text-lg dark:text-white text-black cursor-pointer`}
      >
        <div>
          <h1 className={`h-full`}>
