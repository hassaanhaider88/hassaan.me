...
const HeroLeftText = () => {
  return (
    <div id='Main'  className='relative flex justify-center items-center w-full md2:w-1/2 h-screen'>
        ...
        <h1 id="NameHeading" className="relative my-5 text-7xl text-black dark:text-white">Hassaan <br /> Haider</h1>
