...
const HeroLeftText = () => {
  return (
    ...
    >
      ...
      >
        <h1 className="xsm:block bottom-[55%] sm:bottom-0 left-[7%] sm:left-0 sm:static absolute hidden w-[545px] sm:rotate-0 text-[rgb(104,86,86)] text-nowrap text-xl sm2:text-5xl sm:text-5xl xsm:text-2xl md2:text-7xl dark:text-[#ffffff60] uppercase open-sans rotate-90">
          <TypingAnimation />
        </h1>
        <h1
          id="NameHeading"
...
const TypingAnimation = () => {
  const phrases = [
    { text: "FULL StACK DEVELOPER", icon: null },
    {
  ...
  return (
    <div className="flex items-center font-bold text-[rgb(104,86,86)] text-3xl dark:text-[#ffffffd2]">
      {displayedText}
      {displayedText === phrases[currentPhraseIndex].text &&
