...
const HeroRightImage = () => {
  ...
  return (
    ...
    <div  className='md2:block relative flex justify-center items-center w-full md2:w-1/2 h-[50vh] xsm:h-[70vh] md2:h-screen overflow-hidden'>
      <div id='PersonalImgContainerOne' className='top-4 md2:top-auto bottom-0 md2:-bottom-20 absolute flex justify-center items-center border-[#d914b8] border border-t-transparent rounded-full w-[240px] xsm:w-[440px] h-[240px] xsm:h-[440px]'>
      <div id='PersonalImgContainer' className="absolute flex justify-center items-center bg-gradient-to-r from-[#797979] dark:from-[#0ca2da] via-[#cbb9e9] to-[#ffffff] dark:to-[#f34ae4] rounded-full w-[200px] xsm:w-[400px] h-[200px] xsm:h-[400px] BigCirleImageContainer circle-pattern overfl">
       <img id='PersonalImg' src="../../hassaan_Img.png" height={490} className='bottom-5 md2:bottom-[15%] z-10 absolute' width={400}  alt="" />
      </div>
      </div>
    </div>

    <div className={`${IsCVDownloaderOpen ? "flex" : "hidden" }  top-1/2 left-1/2 z-50 fixed py-10 justify-center items-center bg-[#999]  w-[100vw] h-[100vh] -translate-x-1/2 -translate-y-1/2`} >
    ...
    <img src="../../MyCV.jpeg" width={"100%"} height={'85%'} alt="" />
     ...
     <DownloadCV setIsCVDownloaderOpen={setIsCVDownloaderOpen} IsCVDownloaderOpen={IsCVDownloaderOpen}/>
